                ...
                {filters.jobTitles.length > 0 && (
                  <div className="flex flex-wrap gap-2 mb-4">
                    {filters.jobTitles.map(title => (
                      <span
                        key={title}
                        className={`inline-flex items-center px-3 py-1 rounded-full text-sm ${darkMode ? 'bg-blue-900 text-blue-300' : 'bg-blue-50 text-blue-700'}`}
                      >
                        {title}
                        <button
                          onClick={() => handleRemoveJobTitle(title)}
                          className={`ml-2 ${darkMode ? 'text-blue-400 hover:text-blue-300' : 'text-blue-500 hover:text-blue-700'}`}
                        >
                          <X className="w-4 h-4" />
                        </button>
                      </span>
              ...
              <div className="space-y-2">
                {[
                  ...
                  <label key={availability} className="flex items-center">
                    ...
                    />
                    <span className={`${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>{availability}</span>
                  </label>
                ))}
              </div>
            </div>
